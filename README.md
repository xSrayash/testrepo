# Test Deaf APP.
- [x] test for push on branch main: should run TEST-696 and SUITE-29
- [x] test for cron jobs
- [x] test for pull request
- [x] are comments on PR working?
...
- [x] Private key fetch from aws secrets manager
- [ ] Github app creation for local, staging, prod
Polish
- [x] PR Comment (test if it comments on PR) - 9.
- [x] Slack report
